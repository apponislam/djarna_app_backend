...
const getFollowers = async (userId: string) => {
    const result = await FollowModel.find({ following: userId }).populate("follower", "_id name email phone photo address verifiedBadge").lean();
    return result;
};
...
const getFollowing = async (userId: string) => {
    const result = await FollowModel.find({ follower: userId }).populate("following", "_id name email phone photo address verifiedBadge").lean();
    return result;
};
